...
\usepackage{ngerman}\usepackage{amsmath}\usepackage{caption2}
\usepackage{graphicx}
...
\chapter{Lorem ipsum chapter} Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
cursus neque massa at diam. \section{Lorem ipsum section} Ut vitae mi massa. Proin nec elementum sem.
...
In in luctus justo. Vivamus sagittis urna orci. \subsection{Lorem ipsum subsection} Praesent lobortis, ante at tempus eleifend, est dolor tincidunt nulla,
...
\section{Dummybild und Referenz}
  ...
  \begin{figure}[htbp]
    \centering\includegraphics[width=\textwidth,angle=30]{imgfoo}\caption{Bildfoo}\label{img:foo}
  \end{figure}
