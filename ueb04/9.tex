...
%\usepackage{ngerman}%
\usepackage{amsmath}
\usepackage{caption2}%\usepackage{nichtda}
\usepackage{graphicx}%
...
%\section{Ich bin auskommentiert}
%\section{Ich bin auskommentiert}%
\section{Ich bin nicht auskommentiert}%
...
%\subsection{Ich bin auskommentiert}
%\subsection{Ich bin auskommentiert}%
\subsection{Ich bin nicht auskommentiert}%
SPraesent lobortis, ante at tempus eleifend, est dolor tincidunt nulla,
...
%\chapter{Ich bin auskommentiert}
%\chapter{Ich bin auskommentiert}%
\chapter{Ich bin nicht auskommentiert}%

\section{Blindtext}%\section{Dieser Bildtext ist auskommentiert}
...
%\includegraphics{ichbinnichtda}%
\includegraphics{ichbinda}
\includegraphics{ichauch}%\includegraphics{ichnicht}
...
\chapter{Links}%\chapter{Auskommentiertes Chapter}
