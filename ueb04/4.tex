...
\includegraphics[width=\textwidth,angle=30]{imgfoo}\includegraphics{bar}\includegraphics[height=2cmi]{gnasl}
...
\chapter{Links}\section{Mehr Links}\subsection{Und noch viel mehr von den Links}
